...
public abstract class BaseCommand
{
	...
	public boolean run(CommandSender csender, String[] preArgs, String cmd)
	{
		...
		{
			Notifier.sendMessage(NotifierType.REGULAR, sender, Colors.Red + "Wrong arguments supplied!");
			sendUsage();
			return true;
		}
		...
		if (!permission())
		{
			Notifier.sendMessage(NotifierType.REGULAR, sender, Colors.Red + "You do not have permission to do that!");
			return false;
		}
	...
	{
		Notifier.sendMessage(NotifierType.REGULAR, sender, Colors.Red + "/" + usedCommand + " " + name + " " + usage);
	}
